...
The dataset isn't fixed. GoodFit adds new groups, fields, and custom classifiers based on what partners need. If you need something that's not in the current data directory, you can request it.
