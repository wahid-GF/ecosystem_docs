...
The partner defines which data blocks and parameters matter. GoodFit configures the dataset. The partner builds the UI. Users query the dataset like it's native.
